...
const settingsStore = await import("../src/shared/settings/user-settings-store.js?v=16.8.0.1");
const progressQueue = await import("../src/shared/progress/progress-queue.js?v=16.8.0.1");
