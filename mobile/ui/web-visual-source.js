...
export const WEB_VISUAL_TOKENS = Object.freeze({
  ...
  chrome:Object.freeze({contentRestGap:16,actionEdgeGap:16,headerSide:10,headerSideCompact:6,headerCenterInset:56,navSide:12,navSideCompact:8,actionSize:36,actionIconSize:20,navBubbleSize:38,navBubbleCompactSize:36,blur:10,controlBlur:8,compactWidth:360,screenDepths:Object.freeze({default:Object.freeze({top:58,bottom:16}),bottomNav:Object.freeze({top:58,bottom:76}),path:Object.freeze({top:60,bottom:76}),stationWords:Object.freeze({top:102,bottom:108}),stationStatistics:Object.freeze({top:80,bottom:16}),setPreparation:Object.freeze({top:96,bottom:94}),setPreparationWithTest:Object.freeze({top:96,bottom:138}),learn:Object.freeze({top:58,bottom:80}),testMenu:Object.freeze({top:58,bottom:93}),matchMenu:Object.freeze({top:58,bottom:54}),testSession:Object.freeze({top:58,bottom:16}),testResults:Object.freeze({top:178,bottom:54}),matchGame:Object.freeze({top:58,bottom:16}),matchResults:Object.freeze({top:58,bottom:16}),profile:Object.freeze({top:42,bottom:76})})}),
  ...
  segmented:Object.freeze({padding:2,itemMinHeight:28,itemMinWidth:38,radius:999,settingsActiveAlpha:.72,setActiveAlpha:.82,testActiveAlpha:.86,songsActiveAlpha:.84}),
