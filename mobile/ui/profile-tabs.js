...
const styles=StyleSheet.create({
  ...
  profileTabText:{fontFamily:theme.font.terminal,fontSize:T.fontSize,fontWeight:'750',lineHeight:T.lineHeight,color:C.text3,textAlign:'center'},
