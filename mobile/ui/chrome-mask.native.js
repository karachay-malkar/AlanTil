...
const styles=StyleSheet.create({mask:{position:'absolute',zIndex:29,elevation:29,shadowColor:'transparent',left:0,right:0,overflow:'hidden'},top:{top:0},bottom:{bottom:0}});
