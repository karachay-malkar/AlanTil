...
function persistentState(value={}){return{general_completed:Boolean(value?.general_completed),learning_completed:Boolean(value?.learning_completed),repeat_hint_shown:Boolean(value?.repeat_hint_shown)};}
