...
test('Native screen uses Alan Til Header and SegmentedControl',()=>{const screen=read('mobile/screens/ashyk.js');assert.match(screen,/<Header title=\{m\.title\} onBack=/);assert.match(screen,/SegmentedControl/);assert.match(screen,/m\.modeLabel/);assert.match(screen,/m\.difficultyLabel/);assert.match(screen,/m\.shotType/);assert.match(screen,/m\.top/);assert.match(screen,/m\.orbit/);});
