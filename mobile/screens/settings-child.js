...
function Privacy({settings,type}){
  ...
  return <Document>
    {p(<><Text style={styles.strong}>osuyat </Text>{msg(settings,'privacy.prilozhenie_dlya_izucheniya_karachaevo_balkarskogo_yazyka_')} <Text style={styles.emailLink}>alantil0709@gmail.com</Text>.</>)}
...
const styles=StyleSheet.create({document:{width:'100%',maxWidth:620,alignSelf:'center',paddingTop:theme.control.header+theme.chrome.contentRestGap,paddingHorizontal:12,paddingBottom:30},h1:{color:C.text1,marginBottom:4},h2:{marginTop:22,marginBottom:9,color:C.text1,fontSize:16,lineHeight:19,fontWeight:'800'},p:{marginTop:10,color:C.text2,fontSize:14,lineHeight:23},strong:{fontWeight:'800',color:C.text1},emailLink:{color:C.text1,textDecorationLine:'underline'},documentDate:{marginTop:10,marginBottom:18,color:C.text3,fontFamily:theme.font.terminal,fontSize:11,lineHeight:14,fontWeight:'700'},fact:{minHeight:46,flexDirection:'row',alignItems:'center',justifyContent:'space-between',borderBottomWidth:1,borderBottomColor:C.lineSoft},factLabel:{color:C.text2},factValue:{fontFamily:theme.font.terminal,fontWeight:'700',color:C.text1},analytics:{marginTop:20,paddingTop:12,paddingHorizontal:2,borderTopWidth:1,borderTopColor:C.lineSoft},switchRow:{minHeight:46,marginTop:12,flexDirection:'row',alignItems:'center',gap:10,borderBottomWidth:1,borderBottomColor:C.lineSoft},switchLabel:{flex:1,color:C.text1,fontSize:14,lineHeight:23}});
