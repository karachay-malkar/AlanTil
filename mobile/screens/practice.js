...
export function PracticeScreen({ openTest, openMatch, openFavorites, openSongs }) {
  return <Screen bottomNav><Header title="" /><ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}><SectionLabel>ПРАКТИКА</SectionLabel><SurfaceCard style={styles.menu}>
...
const styles = StyleSheet.create({
  scroll: { paddingTop: theme.control.header + 12, paddingHorizontal: 12, paddingBottom: theme.control.nav + 28, gap: 10 },
