...
function UsersList({rows,loading,error,onOpen,s,am,settings,searchOpen,query,onQueryChange}){
  ...
  const storyKeys=[['oblivion',am('admin.story_oblivion')],['roots',am('admin.story_ascent')?am('admin.story_roots'):am('admin.story_roots')],['ascent',am('admin.story_ascent')],['pathways',am('admin.story_pathways')]];
