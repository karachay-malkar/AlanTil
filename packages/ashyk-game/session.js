...
export function createAshykOnlineSessionController({online,userId,store,engine,getRoom,applyRoom,setConnection=()=>{},setVisualConnection=()=>{}}={}){
  let queue=[],flushing=false,resolvingTimeout=false,destroyed=false,visualStream=null,visualRoomId=null,localShotId=null,localShotPhaseSeq=null,localShotCommit=null,trajectoryGeneration=0,lastAimSentAt=0;
