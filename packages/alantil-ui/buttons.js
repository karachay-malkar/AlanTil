...
const def=(mobileKind,style,webClasses,extra={})=>F({mobileKind,style,webClasses:F(webClasses),...extra});
export const BUTTON_ROLES=F({
 ...
 'header.text':def('headerText','headerText',['appHeaderTextAction']),
 ...
 'station.study':def('stationStudy','stationStudy',['btn','stationStudyButton'],{action:true}),
 'station.test':def('stationTest','stationTest',['btn','actionPrimary','stationTestButton'],{action:true}),
 ...
 'songs.info':def('headerText','headerText',['iconAction','appHeaderTextAction','songInfoButton']),
 'songs.play':def('icon','default',['mediaPlayButton']),
 'favorite.toggle':def('favorite','favorite',['starBtn']),
 ...
 'direction.choice':def('segment','default',['directionChoiceButton']),
