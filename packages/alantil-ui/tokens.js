...
export const UI_TOKENS=F({
  ...
  social:F({rowHeight:LIST_TABLE_CONTRACT.standard.medium,rankWidth:LIST_TABLE_CONTRACT.leadingSlot,actionSize:LIST_TABLE_CONTRACT.actionSlot,compactActionSize:LIST_TABLE_CONTRACT.actionSlot,compactWidth:560,searchHeight:38,searchRadius:12}),
  ashyk:F({buttonHeight:38,buttonVertical:7,buttonHorizontal:13,buttonRadius:14,buttonFontSize:13,buttonLineHeight:17,segmentedHeight:34,segmentedItemHeight:28,surfaceRadius:14,dialogRadius:20}),
  favorite:F({size:36,iconSize:23,active:'favorite',inactive:'text3'}),
  account:F({maxWidth:520,gap:16,fieldGap:8,messageMinHeight:18,genderCardMinHeight:210,genderCardGap:12,factRowMinHeight:LIST_TABLE_CONTRACT.standard.medium})
});
