...
export const UI_TOKENS=F({
  ...
  practice:F({rowHeight:68,singleRowHeight:58,leadingSize:36,iconSize:23,gap:10,titleSize:15,subtitleSize:11}),
  social:F({rowHeight:52,rankWidth:30,actionSize:34,compactActionSize:32,compactWidth:560,searchHeight:38,searchRadius:12}),
