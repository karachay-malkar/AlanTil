...
const SCREENS = Object.freeze({
  "path.home": { layout: "map", header: "minimal", bottomNav: true, title: "Путь" },
  "path.station": { layout: "detail", header: "standard", bottomNav: false, title: "Станция" },
  ...
  "practice.home": { layout: "root", header: "minimal", bottomNav: true, title: "Практика" },
  "profile.home": { layout: "root", header: "minimal", bottomNav: true, title: "Профиль" },
  "profile.skills": { layout: "root", header: "minimal", bottomNav: true, title: "Профиль" },
  "profile.statistics": { layout: "root", header: "minimal", bottomNav: true, title: "Статистика" },
  ...
  "settings.home": { layout: "root", header: "minimal", bottomNav: true, title: "Настройки" },
