...
import { initializeProgressSystem } from "../shared/progress/progress-sync.js?v=13.4";
...
import { createRouter } from "./router.js?v=13.4";
import { createShell } from "./shell.js?v=13.4";
