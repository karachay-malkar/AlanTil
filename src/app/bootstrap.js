import { prepareAnalytics } from "../shared/analytics/analytics.js?v=16.8.0.2";
import { APP_VERSION } from "../../packages/alantil-core/release.js?v=16.8.0.2";
import { hasAuthCallback, waitForAuthInitialization } from "../shared/auth/auth-service.js?v=16.8.0.2";
import { hasPersistedAuthSession } from "../shared/auth/supabase-client.js?v=16.8.0.2";
import { initAdminAccess } from "../shared/admin/admin-access.js?v=16.8.0.2";
import { initializeProgressSystem } from "../shared/progress/progress-sync.js?v=16.8.0.2";
import { getInterfaceLanguage, initializeI18n, msg } from "../shared/i18n/index.js?v=16.8.0.2";
import { getSocialClient, startSocialInboxController } from "../shared/social/social-service.js?v=16.8.0.2";
...
import { setPendingAshykInvite } from "../shared/social/ashyk-handoff.js?v=16.8.0.2";
...
import { createTelegramAdapter, initTelegram } from "../shared/platform/telegram.js?v=16.8.0.2";
import { initPrivacyController } from "../shared/privacy/privacy-controller.js?v=16.8.0.2";
import { createModalService } from "../shared/ui/modal.js?v=16.8.0.2";
import { runLearningSetup } from "../features/onboarding/index.js?v=16.8.0.2";
import { createRouter } from "./router.js?v=16.8.0.2";
import { createShell } from "./shell.js?v=16.8.0.2";
...
async function linkRestoredAccountVisit() {
  try {
    const { recordAnonymousPageView } = await import("../shared/analytics/visitor-analytics.js?v=16.8.0.2");
