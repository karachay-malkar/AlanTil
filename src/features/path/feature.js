import { getInterfaceLanguage, msg } from "../../shared/i18n/index.js?v=16.8.0.2";
import { getDisplayedSetName } from "../../shared/domain/alan-display.js?v=16.8.0.2";
import { supabasePublishableKey, supabaseUrl } from "../../config/supabase.js?v=16.8.0.2";
import { getCompleteDictionaryWords } from "../../shared/data/word-repository.js?v=16.8.0.2";
import { buildLearningRoute, resolveStationFromParams, stationPathParams } from "../../shared/domain/learning-route.js?v=16.8.0.2";
import { allStoryProgress, computedStationStatus, createRouteProgressSnapshot, stationWordProgress } from "../../shared/domain/route-progress.js?v=16.8.0.2";
import { getRouteSettings, updateRouteSettings } from "../../shared/progress/route-settings-store.js?v=16.8.0.2";
import { awardWordMilestones } from "../../shared/progress/word-progress-store.js?v=16.8.0.2";
...
import { createRouteScale } from "../../shared/ui/route-scale.js?v=16.8.0.2";
...
import { getHiddenSet, learnState } from "../learn/state.js?v=16.8.0.2";
import { renderResults as renderLearnResults } from "../learn/results.js?v=16.8.0.2";
import { finalizeLearnSession, renderStudy } from "../learn/study.js?v=16.8.0.2";
import { createStationTestSession, renderStationTest } from "./station-test.js?v=16.8.0.2";
import { renderStationView } from "./station-view.js?v=16.8.0.2";
import { hasSeenStoryStele, mountStoryStele } from "./story-stele.js?v=16.8.0.2";
import { readScopedJson } from "../../shared/progress/storage-scope.js?v=16.8.0.2";
import { renderStoryWordList } from "./story-word-list.js?v=16.8.0.2";
...
const SET_ICON_ASSET_VERSION = "16.8.0.2";
