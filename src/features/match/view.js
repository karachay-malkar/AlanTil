...
import { isWordEnabledInTestModes, shuffle } from "../../shared/domain/word-selection.js?v=16.8.0.3";
import { normalizeId } from "../../shared/domain/word-normalizer.js?v=16.8.0.3";
import { buildSelectedSources } from "../../shared/progress/session-builders.js?v=16.8.0.3";
...
import { escapeHtml, renderStarButton } from "../../shared/ui/word-renderers.js?v=16.8.0.3";
import { completeMatch, markSolved, nextRound, recordMismatch, startMatch } from "./engine.js?v=16.8.0.3";
import { matchState } from "./state.js?v=16.8.0.3";
...
export function renderMatchMenu(context, words, signal) {
  ...
  context.root.querySelector("#btnMatchStart").addEventListener("click", async () => {
    ...
    startMatch(pool, matchState.limit, {
      ...
      selectedSources: buildSelectedSources(selected.map((child) => ({ dictionaryId: child.dataset.dict, sectionId: child.dataset.section }))),
    });
