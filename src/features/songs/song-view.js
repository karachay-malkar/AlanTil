...
import { openWordCard } from "../../shared/ui/word-card.js?v=16.8.0.3";
import { escapeHtml } from "../../shared/ui/word-renderers.js?v=16.8.0.3";
import { renderSongLyrics } from "./lyrics-renderer.js?v=16.8.0.3";
import { mountPlayer } from "./player.js?v=16.8.0.3";
