...
import { PAUSE_ICON_SVG, PLAY_ICON_SVG } from "../../shared/ui/icons.js?v=16.8.0.1";
import { renderMediaPlayer } from "../../shared/ui/media-player.js?v=16.8.0.1";
import { resetPlayerState, songsState } from "./state.js?v=16.8.0.1";
