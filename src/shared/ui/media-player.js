import { PLAY_ICON_SVG } from "./icons.js?v=13.8.1";

export function renderMediaPlayer() {
  return `
    <div class="mediaPlayer" aria-label="Аудиоплеер">
      <button class="iconAction mediaPlayButton" type="button" data-audio-play aria-label="Воспроизвести песню">${PLAY_ICON_SVG}</button>
