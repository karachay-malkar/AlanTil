import { analyticsAvailable, appVersion, debugMode, measurementId } from "../../config/analytics.js?v=16.8.0.1";
import {
...
const VISITOR_ANALYTICS_MODULE_URL = "./visitor-analytics.js?v=16.8.0.1";
